...
(function() {
  var AppRouter, Comment, CommentCollection, CommentListItemView, CommentListView, DropdownLabelListItemView, DropdownLabelListView, InlineLabelListItemView, Issue, IssueCollection, IssueListItemView, IssueListView, IssueView, Label, LabelCollection, LabelListItemView, NewIssuePanel, Panel, app, bestContrastingColour, defer, hex2rgb, lumdiff, template, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  IssueListItemView = (function(_super) {
    ...
    IssueListItemView.prototype.template = template('tpl-issue-list-item');
  ...
  IssueListView = (function(_super) {
    ...
    IssueListView.prototype.template = template('tpl-issue-list-panel');
  ...
  IssueView = (function(_super) {
    ...
    IssueView.prototype.template = template('tpl-issue-details-panel');
  ...
  CommentListItemView = (function(_super) {
    ...
    CommentListItemView.prototype.template = template('tpl-comment-list-item');
  ...
  LabelListItemView = (function(_super) {
    ...
    function LabelListItemView() {
      _ref12 = LabelListItemView.__super__.constructor.apply(this, arguments);
      return _ref12;
    }

    LabelListItemView.prototype.template = template('tpl-label-list-item');
  ...
  DropdownLabelListItemView = (function(_super) {
    ...
    function DropdownLabelListItemView() {
      _ref13 = DropdownLabelListItemView.__super__.constructor.apply(this, arguments);
      return _ref13;
    }

    DropdownLabelListItemView.prototype.template = template('tpl-dropdown-label-list-item');
  ...
  DropdownLabelListView = (function(_super) {
    ...
    function DropdownLabelListView() {
      _ref14 = DropdownLabelListView.__super__.constructor.apply(this, arguments);
      return _ref14;
    }

    DropdownLabelListView.prototype.childView = DropdownLabelListItemView;

    DropdownLabelListView.prototype.template = template('tpl-dropdown-label-list');
  ...
  AppRouter = (function(_super) {
    ...
    AppRouter.prototype.showPanel = function(id, view) {
      var name, panel, _ref16, _results;
      _ref16 = this.panels;
      _results = [];
      for (name in _ref16) {
        panel = _ref16[name];
