...
(function() {
  var AppRouter, Comment, CommentCollection, CommentListItemView, CommentListView, Issue, IssueCollection, IssueListItemView, IssueListView, IssueView, Label, app, _ref, _ref1, _ref10, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  IssueCollection = (function(_super) {
    ...
    IssueCollection.prototype.url = '/api/issues/all';
  ...
  IssueListView = (function(_super) {
    ...
    IssueListView.prototype.el = jQuery('#issue-list');
  ...
  AppRouter = (function(_super) {
    ...
    AppRouter.prototype.initialize = function(config) {
      this.route('', 'list');
      this.route('issues/:id', 'showIssue');
      this.route('labels/:name', 'showLabel');
    ...
    AppRouter.prototype.list = function() {
      ...
      return this.showPanel('#issue-list-panel');
    };
  ...
  window.init = function(issues) {
    ...
    jQuery("a:not([href^='http://'])").click(function(evt) {
      evt.preventDefault();
